...
See the [POM file](https://github.com/krrishkishore/github-maven-example/blob/master/example/pom.xml)
...
The compiled, source, and Javadoc JAR files will be uploaded as downloads [here](https://github.com/krrishkishore/github-maven-example/downloads).
...
The generated site will be committed to the [gh-pages branch](https://github.com/krrishkishore/github-maven-example/tree/gh-pages) and visible [here](http://krrishkishore.github.com/github-maven-example/).
